 ...
 */
define( [
   '../ax-log-display-widget',
   'laxar/laxar_testing'
], function( widgetModule, ax ) {
   'use strict';

   describe( 'An AxEventsDisplayWidget', function() {
      ...
      beforeEach( function() {
         ...
         testBed = ax.testing.portalMocksAngular.createControllerTestBed( 'developer-tools/ax-log-display-widget' );
