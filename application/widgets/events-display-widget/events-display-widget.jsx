...
export default class EventsDisplayWidget extends React.Component {
   static get injections() {
     return [ 'axContext', 'axReactRender' ];
   }

   constructor(props) {
      super(props)

      const { axContext: context, axReactRender: reactRender } = props;
      this.injections = { context, reactRender };
      ...
      this.filterBySearch = function filterBySearch( event ) {
      ...
      this.limitEvents = function limitEvents( event ) {
      ...
      this.refreshProblemSummary = function refreshProblemSummary() {
      ...
      this.onSettingsChanged = function onSettingsChanged( type, group, name, state ) {
      ...
      this.discardEvents = function discardEvents() {
         model.eventInfos = [];
      ...
      this.handleSelection = function handleSelection( selectedEvent ) {
               ...
               <div>
                  ...
                  <div className="ax-button-wrapper form-inline">
                     <FiltersAndLimitForm name={ model.settings.namePattern }
                                          filterId={ context.id( 'filter' ) }
                                          limitId={ context.id( 'limit' ) }
                                          filterBySearch={ filterBySearch }
                                          limit={ model.settings.visibleEventsLimit }
...
class FiltersAndLimitForm extends React.Component {
   ...
   render() {
      ...
      const limitId = this.props.limitId;
      ...
      return (
         <div className={
            ...
            <button type="button"
                    ...
                    aria-expanded={ this.state.showPatterns }>
      ...
      const events = this.props.events.map( event => {
         return (
            <EventBody event={event}
                       key={event.index}
                       viewPatternsByName={this.props.view.patternsByName}
